...
- **ドックバー操作強化** (v0.15) — ドックバーはドラッグで自由配置、位置は再起動後も保持。パネル→ドック遷移時にスライドアニメーションを表示
...
最新リリース: **v0.16.0** (2026-05-09)。変更履歴は [CHANGELOG.md](CHANGELOG.md)、ロードマップは [SPEC.md §17](SPEC.md) を参照してください。公開リリースですが、作者は安定性を保証しません。
