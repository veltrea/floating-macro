...
final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    private func buildContextMenu() -> NSMenu {
        ...
        menu.addItem(NSMenuItem(title: "Scroll Debug…", action: #selector(toggleScrollDebug), keyEquivalent: ""))
        ...
        menu.addItem(NSMenuItem(title: L("編集_ac1264"), action: #selector(openSettings), keyEquivalent: "e"))
    ...
    @objc private func toggleScrollDebug() {
        ScrollDebugWindow.toggle()
    }
    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            if let preset = panelPreset {
                ...
                PanelScrollView(
                    initialY: initialY,
                    debugLabel: "\(preset.displayName ?? preset.name) (\(panelID.prefix(8)))",
                    onScrollChange: { y in
