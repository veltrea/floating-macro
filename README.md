...
Latest release: **v0.15.0** (2026-05-07). See [CHANGELOG.md](CHANGELOG.md) for the change history and [SPEC.md §17](SPEC.md) for the roadmap. Public release, but the author makes no guarantees of stability.
