...
public enum ToolCatalog {
    ...
    public static let tools: [ToolDefinition] = [
        ...
        .init(name: "window_opacity",
              description: "DEPRECATED: prefer panel_create with an explicit opacity. Sets the primary panel's opacity. Clamped to [0.25, 1.0].",
        ...
        .init(name: "window_move",
              description: "DEPRECATED: future panel_move will accept an id. Moves the primary panel to absolute screen coordinates (origin bottom-left).",
        ...
        .init(name: "window_resize",
              description: "DEPRECATED: future panel_resize will accept an id. Resizes the primary panel. Width must be >= 120, height >= 80.",
