...
final class ConfigLoaderTests: XCTestCase {
    ...
    func testPanelConfigRoundTrip() throws {
        ...
        XCTAssertTrue(decoded.minimizedToEdge)
        XCTAssertFalse(decoded.visible)
    }

    func testPanelConfigDecodesMinimalJSON() throws {
        // presetName 以外を省略しても decode できる（visible=true / minimizedToEdge=false）。
        let json = #"""
        ...
        XCTAssertFalse(decoded.minimizedToEdge)
    ...
    func testAppConfigLegacyJSONMigratesToSinglePanel() throws {
        ...
        XCTAssertFalse(decoded.panels[0].minimizedToEdge)
    ...
    func testAppConfigWithMultiplePanelsRoundTrips() throws {
        let panels = [
            ...
            PanelConfig(id: "p-mj", presetName: "midjourney-gallery",
                        ...
                        minimizedToEdge: false, visible: true),
            PanelConfig(id: "p-hidden", presetName: "accessibility",
                        window: WindowConfig(),
                        minimizedToEdge: true, visible: false),
        ]
        ...
        XCTAssertTrue(decoded.panels[2].minimizedToEdge)
