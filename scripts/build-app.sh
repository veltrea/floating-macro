...
say "Compiling (release, universal) …"
swift build -c release --product FloatingMacro --arch arm64 --arch x86_64 >/dev/null
BIN_DIR="$(swift build -c release --product FloatingMacro --arch arm64 --arch x86_64 --show-bin-path)"
